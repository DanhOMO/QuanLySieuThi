...
CREATE TABLE VOUCHER (
  SOVOUCHER INT IDENTITY(1,1) PRIMARY KEY, 
  MAVOUCHER NVARCHAR(11) NOT   
  MOTA NVARCHAR(100), 
  NGAYBD DATETIME, 
  NGAYKT DATETIME, 
...
CREATE TABLE GIAMGIASP (
  ...
  MASP INT,
  IS_DELETED BIT,
  CONSTRAINT FK_GIAMGIASP_SANPHAM FOREIGN KEY (MASP) REFERENCES SANPHAM(MASP)
);
...
CREATE TABLE CTPHIEUHUY (
  ...
  CONSTRAINT FK_CTPHIEUHUY_PHIEU FOREIGN KEY (MAPHIEU) REFERENCES PHIEUHUY(MAPHIEU),
  CONSTRAINT FK_CTPHIEUHUY_SP FOREIGN KEY (MASP) REFERENCES SANPHAM(MASP)
);
...
CREATE TABLE CTPHIEUNHAP (
  ...
  SOLUONG INT, 
  PRIMARY KEY (MAPHIEU, MASP),
  CONSTRAINT FK_CTPHIEUNHAP_PHIEU FOREIGN KEY (MAPHIEU) REFERENCES PHIEUNHAP(MAPHIEU),
...
CREATE TABLE HOADON (
  ...
  CONSTRAINT FK_HOADON_VOUCHER FOREIGN KEY (SOVOUCHER) REFERENCES VOUCHER(SOVOUCHER)
);
...
CREATE TABLE LOGIN_DETAIL (
  ...
  AUTH_KEY NVARCHAR(50), 
  IP_ADDRESS NVARCHAR(20), 
  MAC_ADDRESS NVARCHAR(20), 
  LOGIN_TIME DATETIME, 
  LOGOUT_TIME DATETIME, 
  SOTK INT,
  CONSTRAINT FK_LOGIN_TAIKHOAN FOREIGN KEY (SOTK) REFERENCES TAIKHOAN(SOTK)
);
...
-- Reset IDENTITY cho bảng KHACHHANG
DBCC CHECKIDENT ('KHACHHANG', RESEED, 0);
-- Reset IDENTITY cho bảng VOUCHER
DBCC CHECKIDENT ('VOUCHER', RESEED, 0);
-- Reset IDENTITY cho bảng GIAMGIASP
DBCC CHECKIDENT ('GIAMGIASP', RESEED, 0);
-- Reset IDENTITY cho bảng PHIEUNHAP
DBCC CHECKIDENT ('PHIEUNHAP', RESEED, 0);
-- Reset IDENTITY cho bảng CTPHIEUNHAP
DBCC CHECKIDENT ('CTPHIEUNHAP', RESEED, 0);
-- Reset IDENTITY cho bảng PHIEUHUY
DBCC CHECKIDENT ('PHIEUHUY', RESEED, 0);
...
-- Đặt lại giá trị IDENTITY của bảng SANPHAM


-- Chèn dữ liệu vào bảng SANPHAM
INSERT INTO SANPHAM (TENSP,MOTA, SOLUONG, HINHANH, GIATIEN, MALOAI, MANCC, IS_DELETED)
VALUES 
...
INSERT INTO TAIKHOAN (SOTK, TENTK, MATKHAU, MANV, SOLANSAI, NGAYTAO, IS_DELETED) 
VALUES
    ...
    (5, N'trungquyen', N'123', 5, 0, '2022-05-16', 0);
...
-- Insert khách hàng
INSERT INTO KHACHHANG (TENKH, GIOITINH, SODIENTHOAI, DIACHI, EMAIL, DIEMTHUONG, IS_DELETED) 
VALUES 
...
-- Insert voucher
INSERT INTO VOUCHER (MAVOUCHER, MOTA, NGAYBD, NGAYKT, GIATRITOITHIEU, KMTOIDA, PTGIAM, SOLUOTSD, IS_DELETED)
VALUES
...
INSERT INTO GIAMGIASP (NGAYBD, NGAYKT, PTGIAM, MASP, IS_DELETED)
VALUES
...
INSERT INTO PHIEUNHAP (NGAYLAP, MANV, IS_DELETED)
VALUES 
...
-- Insert phiếu hủy
INSERT INTO PHIEUHUY (NGAYLAP, MANV, IS_DELETED)
VALUES 
...
ALTER TABLE dbo.ctphieuhuy DROP CONSTRAINT FK_CTPHIEUHUY_PHIEU;
...
ALTER TABLE dbo.CTPHIEUHUY
ADD CONSTRAINT FK_CTPHIEUHUY_PHIEU
FOREIGN KEY (MAPHIEU) 
REFERENCES dbo.PHIEUHUY (MAPHIEU)
ON DELETE CASCADE;
